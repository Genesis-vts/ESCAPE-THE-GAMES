...
| Por quê                                                                                                                                            |
| -------------------------------------------------------------------------------------------------------------------------------------------------- |
| Integra a equipe do **PRO-AMITI**                                                                                                                  |
| Coordena o **GEAT** — Grupo de Estudos sobre Adições Tecnológicas                                                                                  |
| Psiquiatra da **infância e adolescência**                                                                                                          |
| Integra o **grupo de trabalho da OMS** sobre uso problemático de jogos digitais                                                                    |
| Primeiro autor do capítulo "Dependência de jogos eletrônicos em crianças e adolescentes" — a fonte de [DATA_SOURCES.md §4.1.1](../DATA_SOURCES.md) |
| Coautor com Hermano Tavares em livro sobre saúde mental, tecnologia e dependência                                                                  |
...
e dado de contato pessoal de terceiro não entra em repositório público sem
consentimento. Busque no Lattes/CNPq e use o que estiver listado lá, ou vá pelo canal
institucional do GEAT.
...
| 3   | Prof. Dr. Hermano Tavares | Via (1) ou (2)                                | Depois, idealmente apresentado                    |

---

## Mensagem curta para a secretaria

> **Assunto:** Encaminhamento — proposta de colaboração de pesquisa (não é solicitação de atendimento)
>
> Prezada equipe,
>
> Não se trata de pedido de consulta ou de vaga em curso. Somos um projeto de software
> em saúde comportamental e gostaríamos de submeter uma proposta de **colaboração
> científica** ao PRO-AMITI — especificamente ao Dr. Daniel Spritzer e ao Prof. Dr.
> Hermano Tavares.
>
> Seria possível encaminhar a carta em anexo a quem for apropriado? Se houver outro
> canal mais adequado para esse tipo de contato, agradeço a indicação.
>
> Obrigado pela atenção,
> [nome] · [e-mail] · [telefone]

Curta de propósito. Quem tria caixa de entrada decide em segundos, e a primeira linha
já diz o que **não** é — que é a informação que evita a triagem errada.
...
> **Se enviar ao Dr. Spritzer, troque o parágrafo de abertura pela variante em
> "Abertura alternativa", no fim deste documento. Ela é mais específica e verdadeira,
> e vale mais do que qualquer apresentação genérica.**
...
## Abertura alternativa — para o Dr. Daniel Spritzer

Substitui os dois primeiros parágrafos. O resto da carta segue igual.

**Assunto:** O seu capítulo mudou uma decisão de desenho no nosso projeto — proposta de
colaboração

Prezado Dr. Daniel Spritzer,

Escrevo em nome do ESCAPE-THE-GAMES, projeto de software voltado a pessoas em
recuperação de uso problemático de apostas e jogos. O motivo direto desta carta é o seu
capítulo sobre dependência de jogos eletrônicos em crianças e adolescentes.

Duas passagens dele nos fizeram mudar o produto. A primeira é a de que, ao contrário
das dependências de substância, o objetivo de tratamento em jogo eletrônico
usualmente não é a abstinência, mas a moderação. A segunda é a de que o tempo de jogo é
marcador indireto, já que há jogadores de uso intenso sem prejuízo algum.

Nossa métrica principal era "horas de jogo evitadas". Depois de ler o capítulo,
registramos no repositório que ela está errada para jogo eletrônico — mede o marcador
indireto e penaliza quem joga muito sem sofrer dano — e que apostas e jogo eletrônico
podem exigir produtos com meta terapêutica diferente. Essa decisão de escopo continua
aberta, e é uma das razões de procurarmos vocês.

Procuro o programa não para pedir avaliação de um produto, mas para propor uma
colaboração de pesquisa — e para submeter à crítica de vocês uma pergunta que nos
parece relevante e que hoje não tem resposta no Brasil.

[segue a partir de "**O que construímos, e por quê**"]

---

## Uma segunda pergunta, se o interlocutor for o Dr. Spritzer

Além do efeito telescópio, vale oferecer esta — está mais perto do trabalho dele e da
literatura de convergência ([DATA_SOURCES.md §4.4](../DATA_SOURCES.md)):

> A trajetória jogo eletrônico → loot box → aposta online descreve um subgrupo
> identificável no Brasil? A evidência internacional sustenta a migração, mas cerca de
> 80% dos compradores de loot box que apostam **não** relatam efeito passarela — o que
> sugere um subgrupo específico, e não uma progressão geral. Quem é esse subgrupo aqui?

É uma pergunta que a nossa telemetria consegue ajudar a responder e que a clínica
sozinha não alcança — porque exige observar quem **ainda não** chegou ao serviço.
